...
# Script to download and prepare all reference databases (including genome) for rheMac10
# call using
# makedbs_rheMac10.sh ?options? ?dest? ?webcache?
# where 
# * dest: the directory where the reference databases will be installed (default /complgen/refseqnew/rheMac10)
...
set genomeurl {}
# Where are the pseudoautosomal regions (PAR) located in the rheMac10 Rhesus monkey genome reference? Please give genomic coordinates, and indicate where you found the stated numbers.
# https://pmc.ncbi.nlm.nih.gov/articles/PMC9575207/
...
# dbsnp depricated for Rhesus monkey
set dbsnpversion {}
set refSeqFuncElemsurl https://ftp.ncbi.nlm.nih.gov/genomes/refseq/vertebrate_mammalian/Macaca_mulatta/annotation_releases/103/GCF_003339765.1_Mmul_10/GCF_003339765.1_Mmul_10_genomic.gff.gz
# no mirbase
set mirbase {}
...
cg_options makedbs_rheMac10.sh argv {
} {dest webcache} 0 2
