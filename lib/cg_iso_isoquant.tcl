...
proc convert_isoquant {isodir destdir sample refseq reggenedb reggenedbtsv} {
	set strictpct 90
	...
	sqanti3 [file root $knownfile].gtf $destdir/sqanti3-isoquant_known-$sample $refseq $reggenedb
