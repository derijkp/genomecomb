...
proc convcgcnv {srcfile dstfile} {
	...
	set nfields [list_concat {chr begin end {type=$calledCNVType}} [list_remove $fields chr begin end calledCNVType]]
	cg select -f $nfields -q {$calledCNVType != "hypervariable" && $calledCNVType != "\=" && $calledCNVType != "invariant"} $srcfile $dstfile.temp
