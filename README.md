...
[archive](https://github.com/derijkp/genomecomb/releases/download/0.114.0/genomecomb-0.114.0-Linux-x86_64.tar.gz)
...
```
cd ~/bin
wget https://genomecomb.bioinf.be/download/genomecomb-0.114.0-Linux-x86_64.tar.gz
tar xvzf genomecomb-0.114.0-Linux-x86_64.tar.gz

# optional if ~/bin is not in your PATH already
export PATH=$HOME/bin:$PATH
# or make a softlink to something in the PATH already
ln -s ~/bin/genomecomb-0.114.0-Linux-x86_64/cg /usr/local/bin/cg
