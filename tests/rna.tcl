...
test multitranscript {basic} {
	...
	file_write tmp/expected.tsv [string trim [deindent {
		chromosome	begin	end	strand	exonStarts	exonEnds	cdsStart	cdsEnd	transcript	gene	geneid	name	exonCount	source	exon_number	count-t1	count-t2
...
test multitranscript {approx match (for novel)} {
	...
	file_write tmp/expected.tsv [string trim [deindent {
		chromosome	begin	end	strand	exonStarts	exonEnds	cdsStart	cdsEnd	transcript	gene	geneid	name	exonCount	count-t1	count-t2
