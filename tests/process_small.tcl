...
test process_small {process_mastr mastr_mx2} {
	...
	checkdiff -y --suppress-common-lines tmp/mastr_mx2_pm/compar/info_analysis.tsv expected/mastr_mx2_pm/compar/info_analysis.tsv | grep -v -E {version_os|param_adapterfile|command|version_genomecomb}
} {}
...
test process_small {process_sample exome yri mx2} {
	...
	checkdiff -y --suppress-common-lines tmp/one_exome_yri_mx2/samples/NA19240mx2/info_analysis.tsv expected//one_exome_yri_mx2/samples/NA19240mx2/info_analysis.tsv | grep -v -E {version_os|param_adapterfile|command|version_genomecomb}
} {}
...
test process_small {process_project exomes yri mx2} {
	...
	foreach file1 [glob tmp/exomes_yri_mx2/compar/info_analysis.tsv tmp/exomes_yri_mx2/samples/*/info_analysis.tsv] {
		...
		checkdiff -y --suppress-common-lines $file1 $file2 | grep -v -E {version_os|param_adapterfile|command|version_genomecomb}
	}
} {}
