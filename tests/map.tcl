...
test map_bwa {map_bwa basic} {
	...
	cg map_bwa -stack 1 -v 2 -paired 1 tmp/ali.bam $::refseqdir/hg19/genome_hg19.ifas [lsort -dict [glob tmp/*.fq.gz]] NA19240m >@ stdout 2>@ stderr
...
test map_bowtie2 {map_bowtie2 basic} {
	test_cleantmp
	file copy data/seq_R1.fq.gz data/seq_R2.fq.gz tmp
	cg map_bowtie2 -stack 1 -v 2 -paired 1 tmp/ali.bam $::refseqdir/hg19/genome_hg19.ifas [lsort -dict [glob tmp/*.fq.gz]] NA19240m >@ stdout 2>@ stderr
	exec samtools view tmp/ali.bam > tmp/ali.sam
