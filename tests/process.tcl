...
test process {process_project exomes_gatkh_yri_chr2122 (haplotypecaller)} {
	...
	diffanalysisinfo tmp/exomes_gatkh_yri_chr2122/compar/annot_compar-*.tsv.analysisinfo expected/exomes_gatkh_yri_chr2122/compar/annot_compar-*.tsv.analysisinfo
