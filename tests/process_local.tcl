...
test process_sample {bwa distrreg} {
	...
	file_write tmp/expected_varall-gatk-rdsbwa-NA19240m.tsv.analysisinfo [subst [deindent {
		...
		gatk-rdsbwa-NA19240m	fastq-mcf	1.1.2-537 adapted	0.110.0	bwa	0.7.15-r1140		hg19	1	gnusort	8.31	genomecomb	0.110.0	coordinate	1	genomecomb	0.110.0	samtools	1.15.1 (using htslib 1.15.1)	gatk	3.8-1-0-gf15c1c3ef	gatk-rdsbwa-NA19240m	gatk	3.8-1-0-gf15c1c3ef	0.110.0	sreg-cov5-rdsbwa-NA19240m.tsv.zst
	}]]\n
