...
int main(int argc, char *argv[]) {
	...
	for (i = 0 ; i < size; i++) {
		...
		todo->varpos.max = todo->varpos.chr;
		if (todo->varpos.start > todo->varpos.max) {todo->varpos.max = todo->varpos.start;} ; if (todo->varpos.end > todo->varpos.max) {todo->varpos.max = todo->varpos.end;} ;
		if (todo->varpos.type > todo->varpos.max) {todo->varpos.max = todo->varpos.type;} ;
		if (todo->varpos.ref > todo->varpos.max) {todo->varpos.max = todo->varpos.ref;} ; 
		if (todo->varpos.alt > todo->varpos.max) {todo->varpos.max = todo->varpos.alt;} ;
