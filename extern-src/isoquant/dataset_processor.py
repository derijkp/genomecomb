...
class DatasetProcessor:
	...
	# adapted (removed threading because it hangs sometime)
        results = starmap(collect_reads_in_parallel, [(sample, chr_id, self.args, self.read_grouper,
...
#        pool.join()
	...
	# adapted (removed threading because it hangs sometime)
        results = starmap(construct_models_in_parallel, [(SampleData(sample.file_list, sample.label + "_" + chr_id,
