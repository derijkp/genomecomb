...
cg select -s {chromosome pos} -f {chromosome {begin=$pos - 1} {end=$pos} {type="snp"} ref alt aaref aaalt hg18_pos genename Uniprot_acc Uniprot_id Uniprot_aapos Interpro_domain cds_strand refcodon SLR_test_statistic codonpos fold-degenerate Ancestral_allele Ensembl_geneid Ensembl_transcriptid aapos SIFT_score Polyphen2_HDIV_score Polyphen2_HDIV_pred Polyphen2_HVAR_score Polyphen2_HVAR_pred LRT_score LRT_pred MutationTaster_score MutationTaster_pred GERP_NR GERP_RS PhyloP_score 29way_pi 29way_logOdds LRT_Omega UniSNP_ids 1000Gp1_AC 1000Gp1_AF 1000Gp1_AFR_AC 1000Gp1_AFR_AF 1000Gp1_EUR_AC 1000Gp1_EUR_AF 1000Gp1_AMR_AC 1000Gp1_AMR_AF 1000Gp1_ASN_AC 1000Gp1_ASN_AF ESP5400_AA_AF ESP5400_EA_AF} pre_var_dbnsfp.tsv pre2_var_${build}_dbnsfp.tsv
cg groupby {chromosome begin end type} pre2_var__dbnsfp.tsv pre3_var__dbnsfp.tsv.tmp
cg select -f {chromosome begin end type {ref=lindex($ref,0)} alt SIFT_score Polyphen2_HDIV_score Polyphen2_HDIV_pred Polyphen2_HVAR_score Polyphen2_HVAR_pred LRT_score LRT_pred MutationTaster_score MutationTaster_pred GERP_NR GERP_RS PhyloP_score 29way_pi 29way_logOdds LRT_Omega ESP5400_AA_AF ESP5400_EA_AF} pre3_var__dbnsfp.tsv var__dbnsfp.tsv.temp
