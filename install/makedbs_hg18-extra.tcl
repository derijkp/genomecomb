...
file delete pre_var_dbnsfp.tsv pre2_var_hg19_dbnsfp.tsv pre3_var_hg19_dbnsfp.tsv
# move dbNSFPzip files to target
cg liftover var_hg19_dbnsfp.tsv.temp ${dest}/liftover/hg19ToHg18.over.chain ${dest}/tmp/${build}/var_${build}_dbnsfp.tsv.temp
...
file copy -force dbNSFP2.0b4.readme.txt ${dest}/${build}/extra/var_${build}_dbnsfp.info
